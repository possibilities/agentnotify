...
with tempfile.TemporaryDirectory(prefix='an-install-', dir='/tmp') as directory:
    ...
    print('Installer checks passed: foreign-file preservation, clean install, legacy alias, running-app refusal, idempotent reinstall, deployed-SHA receipt. All destinations were temporary.')
